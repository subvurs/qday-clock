...
`7b22b0a2…` (re-locked by the 2026-07-03 axis-5 cold-start reversal,
which this branch merges in; axis 3 does not touch it further) and v0.2
hash `96eb797b…` are unchanged by this change (both replay tests green).
Cross-check (rigor §4): the v0.2 fixture's hand-scored
